...
const FooterSection: React.FC = () => {
  return (
    <footer className="bg-healthcare-dark text-white py-12 px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#demo-form" className="text-gray-400 hover:text-white transition-colors">Request Demo</a></li>
